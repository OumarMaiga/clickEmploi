                ...
                @if(Auth::check())
                    <div class="offre-block-number">
                        <div class="offre-block-number-up">
                            <span class="fas fa-suitcase offre-block-number-icon"></span><span class="offre-block-number-word"> {{ $offre_par_profil->count() }} Offre<?= ($offre_par_profil->count() > 1) ? "s " : "" ?> d'emploi</span> 
                        </div>
