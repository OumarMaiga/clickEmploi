            ...
            <form action="{{ route('emploi.update', $emploi->id) }}" method="post">
                ...
                <div class="row">
                    <div class="form-item col-md-6">
                        ...
                        <input id="telephone" class="form-control" type="text" name="telephone" value="{{ $emploi->telephone }}" placeholder="" />
                    </div>
                    <div class="form-item col-md-6">
                        <label for="email">Email</label>
                        <input id="email" class="form-control" type="text" name="email" value="{{ $emploi->email }}" placeholder="" />
                    </div>
                </div>
                ...
                <div class="row">    
                    <div class="form-item col-md-12">
                        ...
                        <textarea id="content" class="form-control tiny" name="content" value="" placeholder="DESCRIPTION ...">{{ $emploi->content }}</textarea>
                    </div>
                </div>
